...
export const RECIPES: Recipe[] = [
    {
        ...
        imgAlt: 'Overhead view of mediterranean chicken kebabs',
    ...
    },
    {
        ...
        imgAlt: 'Overhead view of Italian couscous salad',
    ...
    },
    {
        ...
        imgAlt: 'A stack of blueberry pancakes',
        timePrep: '15',
        timePrepUnit: 'min.',
        timeCook: '15',
        timeCookUnit: 'min.',
    ...
    },
    {
        ...
        imgAlt: 'Cocoa powder being sprinkled over an elegant glass containing tiramisu dessert',
    ...
    {
        group: 'JRL',
        title: 'Grilled Fajita Chicken Kabobs with Vegetables',
        img: '../../assets/images/Fajita-Chicken-Kebabs-2.jpg',
        imgAlt: 'Grilled fajita chicken kabobs with vegetables laying flat on a surface',
        desc: 'Grilled Fajita Chicken Kabobs with Vegetables are a healthy gluten-free, Paleo, keto, and low-carb appetizer or dinner recipe that can be served over rice or eaten in tacos!',
        timePrep: '45',
        timePrepUnit: 'min.',
        timeCook: '15',
        timeCookUnit: 'min.',
        ...
        caloriesUnit: 'kcal',
        author: 'London',
        website: 'https://www.evolvingtable.com/grilled-fajita-chicken-kabobs/',
        websiteDesc: 'Evolving Table',
        ingredientsGroup: [
            {
                ingredientsIndividual: [
                    {
            ...
            {
                heading: 'Fajita Chicken',
                ingredientsIndividual: [
                    {
                        quantity: '2',
                        quantityUnit: 'lbs',
                        ingredient: 'chicken breasts but into 1 1/2" cubes'
                    },
                    {
                        quantity: '2',
                        quantityUnit: 'tablespoons',
                    ...
                    },
                    {
                        quantity: '1',
                        quantityUnit: 'tablespoon',
                        ingredient: 'coconut aminos or soy sauce'
                    },
                    {
                        quantity: '1/2',
                        ingredient: 'recipe for taco seasoning'
                    },
                    {
                        ingredient: 'cilantro'
                    }
        ...
        instructionsGroup: [
            {
                instructionsIndividual: [
                    {
                        step: 'Place cut onion and bell pepper in a large, gallon-sized zip-top bag with 2 Tbsp olive oil, ½ tsp salt and ¼ tsp pepper. Toss to coat and refrigerate until ready to use.'
                    }
                ]
            },
            {
                heading: 'For the Fajita Chicken Marinade:',
                instructionsIndividual: [
                    {
                        step: 'Combine lime juice, ⅓ cup olive oil, soy sauce, and pre-mixed taco seasoning in a medium-sized bowl. Whisk to combine.'
                    },
                    {
                        step: 'In another large, gallon-sized zip-top bag place chicken cubes and marinade. Shake well and refrigerate for 30-45 minutes.'
                    }
                ]
            },
            {
                heading: 'For the Kabob Assembly:',
                instructionsIndividual: [
                    {
                        step: 'While chicken is marinating, soak 12-15 wooden skewers in water until ready to use.'
                    },
                    {
                        step: 'Once chicken is done marinating, alternatively add chicken and veggies to the wooden skewers.'
                    },
                    {
                        step: 'Heat grill to medium-high. Cook skewers for 3-4 minutes per side, totaling about 10-12 minutes.'
                    },
                    {
                        step: 'Serve these kabobs with cilantro and enjoy over rice, in tacos, or eat them on their own!'
                    }
                ]
            }
        ],
